...
class LookupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lookup" do
    assert_difference('Lookup.count') do
      post lookups_url, params: { lookup: { entity_id: @lookup.entity_id, group_id: @lookup.group_id } }
    end
  ...
  test "should update lookup" do
    patch lookup_url(@lookup), params: { lookup: { entity_id: @lookup.entity_id, group_id: @lookup.group_id } }
